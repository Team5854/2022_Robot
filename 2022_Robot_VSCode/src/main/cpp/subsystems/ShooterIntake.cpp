...
ShooterIntake::ShooterIntake(int shooterLead,int shooterFollow, int stage2, int stage1, frc::Compressor& compressor, int solenoid, int breakbeam1, int breakbeam2, std::initializer_list<bool> motorConfigs):
